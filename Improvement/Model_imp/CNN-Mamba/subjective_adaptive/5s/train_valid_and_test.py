...
def finetune_model(eegdata, eeglabel, sb, patience=10):
    ...
    optimizer = torch.optim.AdamW([
        {'params': model.temporal_conv.parameters(), 'lr': cfg.lr_temporal_conv},
        {'params': model.spatial_conv.parameters(), 'lr': cfg.lr_spatial_conv},
        {'params': model.mamba.parameters(), 'lr': cfg.lr_mamba},
