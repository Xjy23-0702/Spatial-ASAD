...
result_dir='/disk1/jyxu/DaChuang/REFER_CODE/CNN-baseline_Subject_adaptive/5s'
pretrain_model_dir='/disk1/jyxu/DaChuang/REFER_CODE/CNN-baseline_Subject_adaptive/5s/pretrain_model'
finetune_model_dir='/disk1/jyxu/DaChuang/REFER_CODE/CNN-baseline_Subject_adaptive/5s/finetune_model'
