...
result_dir='/disk1/jyxu/DaChuang/REFER_CODE/CNN-baseline_Subject_adaptive/2s'
pretrain_model_dir='/disk1/jyxu/DaChuang/REFER_CODE/CNN-baseline_Subject_adaptive/2s/pretrain_model'
finetune_model_dir='/disk1/jyxu/DaChuang/REFER_CODE/CNN-baseline_Subject_adaptive/2s/finetune_model'
